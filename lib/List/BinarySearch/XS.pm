...
List::BinarySearch::XS - Perl extension for blah blah blah
...
Stub documentation for List::BinarySearch::XS, created by h2xs. It looks like the
...
David Oswald, E<lt>davido@(none)E<gt>

=head1 COPYRIGHT AND LICENSE

Copyright (C) 2013 by David Oswald
